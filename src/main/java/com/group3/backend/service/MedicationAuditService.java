...
//	ArrayList<MedicationCountEntity> getAllMedicationAudits(long medCountId);

	ArrayList<MedicationAuditResponse> getAllAudits(Long medCountId);
//	ArrayList<MedicationAuditResponse> getAuditDay(Date countDoneOnDate, long medCountId);
