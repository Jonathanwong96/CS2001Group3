...
public class EmailMedicationReadyTemplate {
	...
	private final String template = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" + 
			...
			"	<p style=\"font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;\">Medication Status Request</p>\n" + 
			"</div>\n" + 
			"</div>\n" + 
			...
			"<a href=\"http://bing.com\" style=\"text-decoration:none;display:inline-block;color:#ffffff;background-color:#FAD0C9;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:2px solid #000000;border-right:2px solid #000000;border-bottom:2px solid #000000;border-left:2px solid #000000;padding-top:5px;padding-bottom:5px;font-family:Arial, &#39;Helvetica Neue&#39;, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;\"><span style=\"padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;\"><span style=\"font-size: 16px; line-height: 1.5; mso-line-height-alt: 24px;color: #6e6e6d\">Medication is ready for [pharmacy_ready_date]</span></span></a>\n" + 
			...
			"<a href=\"http://google.com\" style=\"text-decoration:none;display:inline-block;color:#ffffff;background-color:#6E6E6D;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:2px solid #000000;border-right:2px solid #000000;border-bottom:2px solid #000000;border-left:2px solid #000000;padding-top:5px;padding-bottom:5px;font-family:Arial, &#39;Helvetica Neue&#39;, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;\"><span style=\"padding-left:47px;padding-right:47px;font-size:16px;display:inline-block;\"><span style=\"font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px;color: #FAD0C9\">More time needed</span></span></a>\n" + 
			"<!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->\n" + 
			"</div>\n" + 
			"<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"divider\" role=\"presentation\" style=\"table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;\" valign=\"top\" width=\"100%\">\n" + 
			"<tbody>\n" + 
	...
	public String getSubstitutedTemplate(EmailEntity emailEntity) {
    	...
    	template = template.replace("[href_accept]", frontEndUrl + "/email/confirmation?" + emailEntity.getNonGuessableId()); //http://localhost:3000/email/confirmation?vb4nqCj3VUCpA7Xr7Mvo
    	template = template.replace("[href_inquiry]", frontEndUrl + "/email/inquiry?" + emailEntity.getNonGuessableId());
